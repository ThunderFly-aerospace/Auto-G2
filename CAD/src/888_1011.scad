...
module 888_1011(){
    ...
    numberOfSpokes    = 8+2;          // Number of "spokes." Set this to three if you're doing the biohazard design
    ...
    hubHeight            = 17-wheelWidth;    // The total height of the hub
    ...
    shaftDiameter        = 2.5+0.4;          // The diameter of the motor shaft
    shaftFlatDiameter    = 2.5+0.4;          // The diameter of the motor shaft at the flat, or shaftDiameter for no flat.
